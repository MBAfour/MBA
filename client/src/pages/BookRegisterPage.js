  ...
  * @description 책 등록시 필요한 data */
  ...
  let settingBookRegisterFunction = {
    ...
    startDate: (e) => {
      ...
      return setBookRegisterInfo((state) => ({ ...state, startDate: startDate }));
    },
    endDate: (e) => {
      const endDate = e.target.value;
      return setBookRegisterInfo((state) => ({ ...state, endDate: endDate }));
    },
    thumbnail: (e) => { //////
  ...
  return (
    ...
    <div>
      ...
      >
        ...
        >
          <Input onChange={settingBookRegisterFunction.title} value={bookApiInfo.title} />
        </Form.Item>
        ...
        >
          <Input onChange={settingBookRegisterFunction.author} value={bookApiInfo.author} />
        </Form.Item>
        ...
        >
          <Input onChange={settingBookRegisterFunction.publisher} value={bookApiInfo.publisher} />
        </Form.Item>
        ...
        <Form.Item name="startDay-picker" label="StartDay" {...config} >
          <DatePicker onChange={settingBookRegisterFunction.startDate} value={bookRegisterInfo.startDate} />
        </Form.Item>
        <Form.Item name="endDay-picker" label="EndDay" {...config}>
          <DatePicker onChange={settingBookRegisterFunction.endDate} value={bookRegisterInfo.endDate} />
        </Form.Item>
        ...
        >
          <Input onChange={bookApiInfo.thumbnail} value={bookRegisterInfo.thumbnail} />
        </Form.Item>
